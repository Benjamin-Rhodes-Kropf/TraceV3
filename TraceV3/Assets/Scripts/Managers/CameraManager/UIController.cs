...
public class UIController : MonoBehaviour
{
    ...
    //It will close the image previewer
            ...
            public void SaveImageLocation()
            {
                ...
                SendTraceManager.instance.fileLocation =
                    "file://" + Application.dataPath + "/SaveImages/Traces/Image.png";
#elif UNITY_IPHONE
        SendTraceManager.instance.mediaType = MediaType.PHOTO;
        SendTraceManager.instance.fileLocation =
 "file://" + Application.persistentDataPath + "/SaveImages/Traces/Image.png";
#endif
            }
        ...
        SendTraceManager.instance.fileLocation = "file://" + path;
            ...
            public void SaveVideo()
            {
                ...
                NativeGallery.Permission permission =
                    NativeGallery.SaveVideoToGallery(path, "TraceVideo", imgName, null);
