...
public class OnlineMapsMarkerManager : OnlineMapsMarkerManagerBase<OnlineMapsMarkerManager, OnlineMapsMarker>
{
    ...
    public static OnlineMapsMarker CreateItem(Vector2 location, string label = null)
    {
        if (instance != null) return instance.Create(location.x, location.y, 0,null,null, null, null, null,label);
        return null;
    }
    ...
    /// <param name="label">Tooltip</param>
    /// <returns>Instance of the marker</returns>
    public static OnlineMapsMarker CreateItem(Vector2 location, Texture2D texture2D, string label)
    {
        if (instance != null) return instance.Create(location.x, location.y, 0,texture2D,null, null, null, null,label);
        return null;
    }
    ...
    {
        if (instance != null) return instance.Create(longitude, latitude,0, null,null, null, null,label);
        return null;
    }
    ...
    {
        if (instance != null) return instance.Create(longitude, latitude,0, texture,null, null, null,label);
        return null;
    }
    ...
    {
        if (instance != null) return instance.Create(longitude, latitude, radius, texture,null, null, null,null,label);
        return null;
    }
    ...
    {
        if (instance != null) return Create(location.x, location.y,  radius, texture, null, null, null, label, traceID);
        return null;
    }
    ...
    /// <param name="label">Tooltip</param>
    /// <returns>Instance of the marker</returns>
    public OnlineMapsMarker Create(double longitude, double latitude, float radius, Texture2D primaryTexture = null, Texture2D primaryHollow = null, Texture2D secondaryTexture = null, Texture2D expieredTexture = null, string label = "", string traceID = "")
    {
        ...
        marker.expieredTexture = expieredTexture;
    ...
    public OnlineMapsMarker AddTraceToMap(double lat, double lng, float radius, Texture2D primaryTexture, Texture2D secondaryTexture, Texture2D primaryHollow, Texture2D expiredTexture, string traceID) {
        OnlineMapsMarker onlineMapsMarker = Create(lng, lat, radius, primaryTexture, primaryHollow,  secondaryTexture,expiredTexture,"", traceID);
